    ...
    if(x !== null && (typeof x === 'object' || typeof x === 'function')){
      ...
      try{//防止then出现异常，Object.defineProperty
        ...
        if(typeof then === 'function'){
          //我们就认为他是promise,call他,因为取出来的then方法中执行环境在本promise,而不是x,(为什么取,因为需要判断x的then是否是函数,then()相当于在本环境调用function,故this指针会改变,所以要保证then执行时的this仍然指向x)的this来自自己的promise对象
